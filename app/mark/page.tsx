    ...
    <>
      <main className="mx-auto max-w-screen-xl pb-48 pt-36 text-gray-900">
        ...
        <section className="relative py-16 pl-24">
          {/* <ScrollSection className="transition-all" threshold={0.5}>
          {(visible) => (
          ...
          >
            ...
            {/* {(visible) => {
              return (
                <p
                  className={clsx(
                    'max-w-2xl text-2xl transition-colors duration-500',
                    {
          ...
          {/* <ScrollSection threshold={0.6}>
          {(visible) => (
            <p
              className={clsx(
                'mt-16 max-w-2xl text-2xl transition-colors duration-500',
                {
                  'text-transparent': !visible,
                },
              )}
        ...
        <ScrollSection
          ...
          nonVisibleClassName="text-transparent"
        >
          {(visible) => (
            <p
              className={clsx(
