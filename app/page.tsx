...
export default function Home() {
  ...
  return (
    <div className="my-auto h-dvh justify-center lg:flex lg:flex-row-reverse">
      <div className="relative my-10 grid grid-cols-12 grid-rows-1 items-center lg:my-20">
        <TwinImage
      ...
      <div className="lg:mx-20 lg:my-auto">
        <div className="px-4">
          <h1 className="w-full text-5xl font-semibold lg:text-7xl">
          ...
          <p className="my-2 text-xl text-gray-400 lg:text-2xl">
            We are software engineers who also like coffee and cats
          </p>
          <button
            className="my-12 flex items-center gap-2 text-2xl lg:text-3xl"
